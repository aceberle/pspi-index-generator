...
public class TestDataGenerator {
	...
	public void generateTestImages(File targetDir) {
		try {
			...
			final ImageModifierFactory modifierFactory = new ImageModifierFactory(
					CropAnchors.parseCropAnchor("top-middle"));
			if (!targetDir.exists()) {
				targetDir.mkdirs();
